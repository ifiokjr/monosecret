# monosecret_py (Python SDK)

The `monosecret_py` distribution (imported as `monosecret`) provides Python bindings for [Monosecret](https://ifiokjr.github.io/monosecret/), a declarative secrets
...
result as a context manager (`with Monosecret.builder()...load() as resolved:`)
