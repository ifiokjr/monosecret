...
case "$(uname -s)" in
  Darwin)               built="libmonosecret_php_native.dylib"; staged="monosecret.so" ;;
  MINGW*|MSYS*|CYGWIN*) built="monosecret_php_native.dll";       staged="monosecret.dll" ;;
  *)                    built="libmonosecret_php_native.so";     staged="monosecret.so" ;;
esac
