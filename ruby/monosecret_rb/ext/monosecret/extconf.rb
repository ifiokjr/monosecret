...
# Builds the monosecret native extension, statically linking the monosecret_ffi
# archive (libmonosecret_ffi.a) into the extension object. A Rust staticlib does
...
include_dir =
  if File.exist?(File.join(vendor, "monosecret.h"))
    vendor
  else
