...
> keyring: Uses system keychain (Recommended)
  ...
  doppler: Doppler secret management (0.4.0+)
  dotenv: Traditional .env files
  file: Plaintext files, one per secret (0.2+)
  env: Read-only environment variables
  null: Use defaults, generation, or run prompts without storage (0.3+)
  systemd-credential: Read-only systemd service credentials (0.3+)
  fly: Fly.io application secrets via flyctl, write-only (0.3+)
  cloudflare: Cloudflare Secrets Store, write-only (0.3+)
  ...
  setec: Tailscale Setec secrets service (0.4.0+)
  vault: HashiCorp Vault secret management
  openbao: OpenBao secret management (0.2+)
  bw: Bitwarden Password Manager (0.2+)
  bws: Bitwarden Secrets Manager
  akv: Azure Key Vault
  aac: Azure App Configuration (0.3+)
  infisical: Infisical secret management (0.3+)
  age: age-encrypted file (0.3+)
  sops: SOPS encrypted files (0.3+)
  kubernetes: Kubernetes (0.3+)
