...
The Cloudflare `cloudflare` provider is added in Monosecret 0.3.
:::
...
| Availability | Monosecret 0.3+; included in official and default builds (`cloudflare` feature for custom minimal builds) |
