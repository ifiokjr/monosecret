...
| Build feature | `kdbx` (0.2+) |
| Default storage | Entry `monosecret/{project}/{profile}/{key}`, field `Password` |
...
The default convention address creates groups for `monosecret`, the project,
